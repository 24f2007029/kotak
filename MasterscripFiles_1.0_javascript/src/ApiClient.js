...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://nsbxapi-gw.kotaksecurities.com/files/1.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://nsbxapi-gw.kotaksecurities.com/files/1.0
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://nsbxapi-gw.kotaksecurities.com/files/1.0",
              'description': "No description provided",
            },
            {
              'url': "http://nsbxapi-gw.kotaksecurities.com/files/1.0",
              'description': "No description provided",
            }
      ];
    }
